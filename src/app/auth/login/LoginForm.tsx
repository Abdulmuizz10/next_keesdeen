      ...
      <div className="flex items-center justify-center px-6 sm:px-12 lg:px-20 py-16">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label
                  htmlFor="password"
                  className="block text-[10px] font-sans font-semibold uppercase tracking-[0.12em] text-neutral-400"
                >
                  Password
                </label>
                <Link
                  href="/auth/forgot-password"
                  className="text-[10px] font-sans uppercase tracking-[0.08em] text-neutral-400 hover:text-neutral-600 transition-colors"
                >
                  Forgot?
                </Link>
              </div>
          ...
          {process.env.NODE_ENV === "development" && (
            <div className="mt-10 py-4 border-t sf-border text-center lg:text-left">
              <p className="text-[10px] font-sans uppercase tracking-[0.08em] text-neutral-400">
                Dev: admin@keesdeen.com / admin123
              </p>
            </div>
          )}
        </motion.div>
